# The provided code is already in Python 3 syntax, but I've made changes
# to improve readability, standardized naming, and added comments for better understanding.
